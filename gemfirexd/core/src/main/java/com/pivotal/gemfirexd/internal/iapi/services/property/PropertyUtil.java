/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.property.PropertyUtil
...
/**
	...
	2) APP - Application set - gemfirexd.properties file
...
public class PropertyUtil {
	...
	*/
	...
	/**
		Property is set in APPLICATION (gemfirexd.properties) set
	*/
...
// GemStone changes BEGIN
        ...
        public static final boolean getBooleanProperty(String propName,
          ...
          String infoVal = findAndGetProperty(info, propName,
              sysPropName, monitor);
        ...
        public static String findAndGetProperty(Properties set, String key,
         ...
         public static String findAndGetProperty(Properties set, String key,
           ...
           String value = systemKey != null ? monitor
               .getJVMProperty(systemKey) : null;
...
// GemStone changes END
	/**
		...
		for finding gemfirexd.properties and reading system properties.
	...
	*/
	...
	public final static void setSQLFire() {
          PropertyUtil.isSQLFire = true;
	}
